...
<html lang="en">
<head>	
	<title>Doctor Appointment Dashboard - Login Page</title>
...
<body class="simple-page">
	...
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
				...
				<span style="color: white">Doctor's Login</span>
		</div>
		<div class="simple-page-form animated flipInY" id="login-form">
	<h4 class="form-title m-b-xl text-center">Sign In With Your Doctor Login Account</h4>
	...
	<hr />
	<a href="signup.php">Sign Up/Registration</a>
</div>
